document.addEventListener("DOMContentLoaded", () => {
  ...
  if(form){
    ...
    form.addEventListener("submit", e=>{
      ...
      if(!form.message.value.trim()){ alert("Please describe your request"); form.message.focus(); return; }
      ...
      .then(()=>{ statusText.textContent="Your request has been sent successfully."; form.reset(); document.querySelector(".char-count").textContent="0 / 2000"; })
